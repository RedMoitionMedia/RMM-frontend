    ...
    <div>
      ...
      <div className='max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 py-8 px-14'>
        <div className='col-span-4'>
          ...
          <h3>Overview</h3>
          <p>
            This app was built using Angular JS. Users are able to set routes
            and search for possible rides based on there location. You will be
            able to save a route and attend a ride of another user. The driver
            is also servied with an navigation system after he started his
            navigation. We use OSM and Mapbox for visual illustration and ORS
            for calculating the duration and direction informations. User
            authentication and authorization are two important issues in this
            project. So you can signup and signin to your account with an email
            address or with your Google-Account to save or attend a ride. This
            is made possible with Google API and our own Python Flask API.
          </p>
          <a
