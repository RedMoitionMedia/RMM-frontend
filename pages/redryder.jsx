    ...
    <div>
      ...
      <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 py-8">
        <div className="col-span-4">
          ...
          <h3>Overview</h3>
          <p>
            This app was built using Next JS and is hosted on Firebase. This is
            a personal Website for the content creator RedRyder. We do not own
            anything from this page and are only allowed to display this here
            for support.
          </p>
          <a href="https://www.redryder.at" target="_blank" rel="noreferrer">
